...
const data = ref([
  { stesen: 'STN-01', lokasi: 'Bangi, Selangor', purata: '0.082', maksimum: '0.11', minimum: '0.05', tempoh: 'Feb 2026' },
  { stesen: 'STN-02', lokasi: 'Dengkil, Selangor', purata: '0.071', maksimum: '0.09', minimum: '0.04', tempoh: 'Feb 2026' },
  { stesen: 'STN-03', lokasi: 'Gebeng, Pahang', purata: '0.118', maksimum: '0.15', minimum: '0.08', tempoh: 'Feb 2026' },
  { stesen: 'STN-04', lokasi: 'Ulu Kinta, Perak', purata: '0.091', maksimum: '0.12', minimum: '0.06', tempoh: 'Feb 2026' },
  { stesen: 'STN-05', lokasi: 'Senai, Johor', purata: '0.065', maksimum: '0.08', minimum: '0.04', tempoh: 'Feb 2026' },
  { stesen: 'STN-06', lokasi: 'Georgetown, P. Pinang', purata: '0.098', maksimum: '0.13', minimum: '0.07', tempoh: 'Feb 2026' }
])
...
<template>
  <div class="space-y-6">
    ...
    <UCard :ui="{ body: 'p-0' }">
      <template #header><p class="text-sm font-semibold text-gray-700">Ringkasan Bulanan - Februari 2026</p></template>
